...
export default async function handler(req, res) {
  ...
  if (callbackQuery) {
    ...
    // Envia resposta para parar o "loading" do botão
  ...
  switch (text) {
    case '/start':
      await sendMessage(chatId, 'Seja muito bem-vindo! Utilize os botões abaixo:', {
        inline_keyboard: [
          [
...
// Função para enviar mensagem ao Telegram (com suporte a botões)
